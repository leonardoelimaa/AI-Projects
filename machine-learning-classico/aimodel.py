...
Original file is located at
    https://colab.research.google.com/drive/153nh_jIs4i9dhmd8GUOGti0ztVTHo9sZ

# Coleta de dados

Este notebook apresenta um fluxo de trabalho clássico de Machine Learning (Aprendizado de Máquina) para criar um modelo de Regressão Linear. O objetivo é prever o valor médio de casas na Califórnia com base em diversas características (como renda média, idade da casa, localização, etc.).
"""
